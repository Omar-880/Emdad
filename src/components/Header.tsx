  ...
  return (
    ...
    >
      ...
      ${language === "ar" ? "after:right-0 ml-8" : "after:left-0"}`}
            ...
            {/* About Dropdown */}
            <div
              className={`relative group ${language === "ar" ? "ml-8" : ""}`}
            >
              <button
        ...
        ${language === "ar" ? "after:right-0" : "after:left-0"}`}
              ...
              <div
                ...
                } mt-2 w-48 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50`}
              >
                <div className="py-2">
